  ...
  const projects = [
    {
      ...
      description:
        "A full-featured e-commerce platform focused on sustainable products with AI-powered recommendations and carbon footprint tracking.",
      image:
      ...
      team: "5 developers",
      results:
        "40% increase in conversion rates, 60% reduction in cart abandonment",
      type: "web",
      status: "Completed",
    },
    {
      ...
      description:
        "An AI-powered mental health application that provides personalized therapy recommendations and mood tracking with NLP-driven insights.",
      image:
      ...
      results:
        "85% user satisfaction, 70% improvement in user mental health metrics",
      type: "ai",
      status: "Completed",
    },
    {
      ...
      description:
        "A comprehensive project management platform with real-time collaboration, automated reporting, and integrated time tracking.",
      image:
      ...
      team: "6 developers",
      results:
        "50% improvement in team productivity, 30% faster project delivery",
      type: "web",
      status: "Completed",
    },
    {
      ...
      description:
        "A comprehensive fitness tracking app with AI-powered workout recommendations, nutrition planning, and social challenges.",
      image:
    ...
    },
    {
      ...
      description:
        "Machine learning system that predicts inventory needs based on historical data, seasonal trends, and market conditions.",
      image:
    ...
    },
    {
      ...
      description:
        "A marketplace connecting creative freelancers with clients, featuring portfolio showcases, secure payments, and project management tools.",
      image:
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Explore the innovative projects we've delivered for clients across
            industries. From web applications to AI solutions, see how we turn
            ideas into reality.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {projects.map((project) => (
              <Card
                key={project.id}
                className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/30 transition-colors group overflow-hidden"
              >
          ...
          <Card className="bg-spark-gradient text-background border-0 overflow-hidden relative">
            ...
            <CardContent className="p-12 text-center relative">
              ...
              <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
                ...
                can bring your vision to life with the same level of excellence
                and innovation.
              </p>
